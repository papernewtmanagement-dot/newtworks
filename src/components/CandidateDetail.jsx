...
export default function CandidateDetail({ candidate, onBack, onUpdate, userRole }) {
  ...
  useEffect(() => {
    ...
    let cancelled = false;
    // v2fcq (Phase 4 quad ranking blocks, live 2026-08-25) has its own scorer;
    // the Likert-only function would pick up stray Stint 1 responses and
    // mis-report item counts (the 2026-08-16 incident above). The Phase 3 pair
    // scorer was retired with the pair section on 2026-08-25.
    const rpcName = src === "v2fcq" ? "compute_newtworks_v2fcq_facets_as_row" : "compute_newtworks_v2_facets_as_row";
    const rpcArgs = src === "v2fcq"
