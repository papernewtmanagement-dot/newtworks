  ...
  return (
    <>
      {/* A muscle turtle flexing both arms and stomping to the beat. Shell on
          ...
          no barbell, no singlet, smaller shell. */}
      ...
      {/* Double-biceps flex: upper arms out, forearms up, arms pump in turn. */}
      <g className="nw-up" style={{ transformOrigin: "80% 90%" }}>
        <path d="M72 108 L40 100 L46 62" fill="none" stroke="#4FA396" strokeWidth="17" strokeLinecap="round" strokeLinejoin="round" />
        <ellipse cx="57.4" cy="98.2" rx="17" ry="13" fill="#4FA396" transform="rotate(14 57.4 98.2)" />
        <path d="M47 93 Q56 85 66 90" fill="none" stroke="#7CC4B7" strokeWidth="3" strokeLinecap="round" />
        <path d="M44.2 73.3 L45.1 67.4" fill="none" stroke="#F2C230" strokeWidth="19" />
        <rect x="38" y="44" width="18" height="18" rx="8" fill="#4FA396" />
        <path d="M49 49 h6 M49 53 h6 M49 57 h6" fill="none" stroke="#3A8074" strokeWidth="2" strokeLinecap="round" />
      </g>
      <g className="nw-upB" style={{ transformOrigin: "20% 90%" }}>
        <path d="M128 108 L160 100 L154 62" fill="none" stroke="#4FA396" strokeWidth="17" strokeLinecap="round" strokeLinejoin="round" />
        <ellipse cx="142.6" cy="98.2" rx="17" ry="13" fill="#4FA396" transform="rotate(-14 142.6 98.2)" />
        <path d="M153 93 Q144 85 134 90" fill="none" stroke="#7CC4B7" strokeWidth="3" strokeLinecap="round" />
        <path d="M155.8 73.3 L154.9 67.4" fill="none" stroke="#F2C230" strokeWidth="19" />
        <rect x="144" y="44" width="18" height="18" rx="8" fill="#4FA396" />
        <path d="M145 49 h6 M145 53 h6 M145 57 h6" fill="none" stroke="#3A8074" strokeWidth="2" strokeLinecap="round" />
      </g>
      <g className="nw-up" style={{ transformOrigin: "50% 0%" }}>
        <rect x="76" y="140" width="22" height="40" rx="9" fill="#4FA396" />
      ...
      <g className="nw-upB" style={{ transformOrigin: "50% 0%" }}>
        <rect x="102" y="140" width="22" height="40" rx="9" fill="#4FA396" />
      ...
      <path d="M62 104 L138 104 L127 152 Q100 166 73 152 Z" fill="#4FA396" />
      <path d="M86 96 L114 96 L136 108 L64 108 Z" fill="#4FA396" />
      <path d="M72 106 Q100 100 128 106 L124 142 Q118 160 100 164 Q82 160 76 142 Z" fill="#C9E8DA" />
      <path d="M100 104 V163 M74 122 Q87 130 100 124 Q113 130 126 122 M77 142 Q88.5 146 100 142 Q111.5 146 123 142" fill="none" stroke="#8FC4AE" strokeWidth="2.5" strokeLinecap="round" />
