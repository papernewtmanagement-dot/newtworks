...
const DYNAMIC_PROCESS_PAGES = {
  "newtworks-who-handles-what": "alpha_split",
};
...
function ProcessesPage({ page, allRows }) {
  ...
  const askContext = useMemo(() => {
    return `I'm looking at this page from our team processes:
