...
// ============================================================
// Newtworks HANDBOOK MODULE v1.0
// Newtworks — State Farm Agent Edition
//
// PURPOSE:
// Read-only viewer for the team handbook. Source of truth
// lives in Confluence (pjsagency.atlassian.net); Newtworks mirrors
...
const TOP_LEVEL_ICONS = {
  ...
  "Health, Safety, & Security":             "🛡️",
  "Information Security":                   "🔒",
  "Property, Systems, & Information":       "🖥️",
  "Signature Page":                         "✍️",
};
  ...
  return (
    <div>
      <p style={{ margin: "0 0 22px 0", fontSize: 12.5, color: T.slate500, fontStyle: "italic" }}>
        Generated live from the team roster. To add, edit, or remove someone, use the Team panel in the Newtworks — this page updates on next load.
      </p>
