// =========================================================================
// zip-apply-webhook bundle (auto-generated)
// Source of truth: supabase/functions/zip-apply-webhook/ + supabase/functions/_shared/
// This single-file bundle is what gets deployed to the Supabase edge runtime.
// Do NOT hand-edit. Regenerate via `python3 scripts/bundle_edge_fn.py zip-apply-webhook`.
// =========================================================================
