...
BEGIN
  ...
  VALUES
    -- ============ AUTO — 111 / $82,204.73 ============
    -- 111 = 3×10 + 9×9; premium $6,850.39×11 + $6,850.44
    ...
    -- ============ FIRE — 99 / $95,412.68 ============
    -- 99 = 3×9 + 9×8; premium $7,951.06×11 + $7,951.02
    ...
    -- ============ LIFE — 21 / $43,405.00 ============
    -- 21 = 9×2 + 3×1; premium $3,617.08×11 + $3,617.12
    ...
    -- ============ HEALTH — 9 / $2,308.40 ============
    -- 9 = 9×1 + 3×0; premium $192.37×11 + $192.33
