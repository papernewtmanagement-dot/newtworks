-- Round the numeric outputs of get_weekly_cpr_requirements to 2 decimals so the
-- Requirements table renders 0.50 rather than 0.50000000. No math change.
-- Companion to 20260808033000 (code reds folded into personal_misses + tenure-ramped cost).
