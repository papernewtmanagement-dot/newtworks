-- Peter 2026-09-20: a sale needs a note, same as a logged activity. Required
-- when it is entered, and an edit cannot empty it out afterwards.
...
DECLARE
  ...
  v_ecrm text; v_source text; v_label text; v_phone text; v_note text;
BEGIN
