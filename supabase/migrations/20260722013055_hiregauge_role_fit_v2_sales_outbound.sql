CREATE OR REPLACE FUNCTION public.cts_role_fit_sales_outbound_v2(p_assessment_id uuid)
RETURNS jsonb
LANGUAGE plpgsql
STABLE
AS $function$
...
BEGIN
  ...
  g := public._cts_role_fit_apply_gates_v2(p_assessment_id, 'sales_outbound', v_raw, v_floor_cap, v_floor_src, v_floor_src_val);
