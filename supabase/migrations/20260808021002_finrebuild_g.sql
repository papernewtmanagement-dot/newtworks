-- content applied from /home/claude/statement_gl_writer.sql -- see repo mirror for full comments
...
BEGIN
  ...
  LOOP
    ...
    v_direction := CASE
      WHEN v_transaction_type IN ('withdrawal','charge') THEN 'debit'
      WHEN v_transaction_type IN ('deposit','payment_or_credit') THEN 'credit'
      ELSE NULL
    END;
