...
BEGIN
  ...
  IF v_checkin_type = 'morning' THEN
    ...
    IF FOUND THEN
      v_text := v_text || format('Yesterday''s EOD: %s/%s%s',
  ...
  ELSE
    -- v8: EOD header now says "Daily Wrapup and EOD checkin!"
    v_text := E'🌙 Daily Wrapup and EOD checkin!\n\n';
  END IF;

  -- v8: single blank line before "If someone's busy" (was \n\n\n, now \n\n)
  v_text := v_text
    || E'Quotes discussed this week / Sales points this quarter\n\n'
    || E'If someone''s busy, answer for them.';

  -- v8: removed "Then begin your daily wrapup." — header already says it

  -- Morning movement reminder (separator stays)
  IF v_checkin_type = 'morning' THEN
    v_text := v_text || E'\n\n━━━━━━━━━━━━━━━━━━━\n'
  ...
  -- v8: separators restored before "📝 Weekly wrapup" and before "📬"
  IF v_checkin_type = 'eod' AND v_dow = 5 THEN
    v_text := v_text || E'\n\n━━━━━━━━━━━━━━━━━━━\n'
      || E'📝 Weekly wrapup — drop your answers below:\n\n'
      || E'1. Biggest obstacle this week?\n'
