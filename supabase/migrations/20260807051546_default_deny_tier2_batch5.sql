-- Batch 5 of 8. ja_anon_insert, jp_public_active, jsq_public_active
-- intentionally NOT touched - public candidate/careers-page paths, same
-- class as job_applications' anon insert, out of scope for this sweep.
