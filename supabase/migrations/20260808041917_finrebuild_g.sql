...
DECLARE
  ...
  v_count_errored int := 0; v_count_skipped_verification int := 0;
...
BEGIN
  ...
  LOOP
    ...
    -- Phase 2a: SKIP verification check, before direct-category match
    ...
    IF v_target_account_id IS NULL THEN
      ...
      BEGIN
        ...
        IF v_rule_id IS NOT NULL AND v_target_code IS NOT NULL THEN
          -- Phase 2b: income exclusion removed from both lookups below
          SELECT id INTO v_target_account_id FROM chart_of_accounts
