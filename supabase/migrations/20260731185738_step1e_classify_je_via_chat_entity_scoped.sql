-- Step 1e of pipeline repair (2026-07-31): rewrite classify_je_via_chat so
-- __SOURCE__ resolves from the JE's other line (not by parsing reference_number),
-- and target lookups prefer same-entity copies. Removes fallback to COA-007
-- which never existed as an account_code.
