...
BEGIN
  ...
  -- Payroll totals per person. Sum ALL comp components including goals_bonus
  -- (previously missing from the sum — Peter flagged 2026-07-13).
  ...
  -- Email order (2026-07-13 revision): WtW status at TOP, then MVP/crossings, then narrative,
  -- then pay, then lookahead. Peter directive: outcome first.
  v_html :=
