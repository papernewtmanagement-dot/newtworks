...
-- Smoke test: verify wtq_trip now carries split metadata
SELECT (public.compute_pool_carveouts('126794dd-25ff-47d2-a436-724499733365', '2026-07-11')::jsonb) -> 'wtq_trip' AS wtq_out;
