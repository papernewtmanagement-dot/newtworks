...
-- Checking 3977 (not personal 0353 as intended). Intercompany treatment:
--   Personal: DR Tithe & Charitable / CR "Owed to PN" (9972)
--   PN:       DR "Owed by Peter" (IC-004) / CR PN Bus Checking 3977
-- Zeros out when Peter reimburses PN (0353 -> 3977 transfer).
--
-- Also creates COA-PN-3977 "US Bank Business Checking (3977)" (was missing).
-- =====================================================================
DO $pf4q$
DECLARE
...
BEGIN
  ...
  UPDATE public.journal_lines
   ...
   WHERE journal_entry_id = v_je_id AND account_id = v_0353_id;
  ...
  VALUES (v_agency_id, v_pn_id, '2026-04-15', 'intercompany_advance',
          ...
          'PN 3977 paid $500 Venmo to Vault for personal donation (should have been 0353). Booked as advance; settles when Peter transfers $500 from 0353 to 3977.')
