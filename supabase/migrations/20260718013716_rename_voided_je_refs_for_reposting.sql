-- Voided JEs keep their unique reference_number, blocking fresh posts. Rename them
-- with -VOIDED suffix so the fresh Plan A post can reuse the canonical reference.
