...
-- Assessment 0.25 → 0.15; Reference 0.20 → 0.30. R and I unchanged.
-- Sum stays 1.00. Shifts weight from Assessment cell to Reference cell within Drivers.
...
--
-- Impact today: minimal — reference scores currently NULL for all cohort candidates, so the
-- 0.20→0.30 change has no effect until reference data is populated. Only the 0.25→0.15 change
-- fires, redistributing drivers_score weighting toward interview/resume.
