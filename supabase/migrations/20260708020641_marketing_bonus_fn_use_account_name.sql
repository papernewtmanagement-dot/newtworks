-- Refactor: lookup 0003 MARKETING envelope by account_name (stable) not account_code (in flux)
...
BEGIN
  ...
  -- Resolve 0003 MARKETING envelope by NAME (stable across the QBO→COA prefix migration)
