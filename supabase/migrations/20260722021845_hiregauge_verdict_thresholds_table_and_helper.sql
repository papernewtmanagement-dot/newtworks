...
-- This migration was applied live on 2026-07-22 02:18:45 UTC (ledger name: hiregauge_verdict_thresholds_table_and_helper) but was never
-- committed to this repo at the time. Content below is copied verbatim
-- from supabase_migrations.schema_migrations.statements for version 20260722021845.
...
-- Sanity check
SELECT layer, pass_threshold, consider_threshold FROM public.hiregauge_verdict_thresholds ORDER BY layer;
