...
-- Peter identified: in-kind goods to Vault Fostering, paid via Venmo from
-- Personal Checking 0353. Updating pf4o placeholder JE to route CR side to
-- 0353 instead of OBE.
--
-- Note: actual Venmo outflow not found in ingested 0353 April data (likely
-- in a statement gap). This JE stands as the accounting record; will
-- reconcile to the bank line when the full April 0353 statement is obtained.
-- =====================================================================
DO $pf4p$
DECLARE
...
BEGIN
  ...
  UPDATE public.journal_lines
   ...
   WHERE journal_entry_id = v_je_id AND account_id = v_obe_id;
