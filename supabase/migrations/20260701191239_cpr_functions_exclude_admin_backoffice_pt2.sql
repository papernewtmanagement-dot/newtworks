...
-- This migration was applied live on 2026-07-01 19:12:39 UTC (ledger name: cpr_functions_exclude_admin_backoffice_pt2) but was never
-- committed to this repo at the time. Content below is copied verbatim
-- from supabase_migrations.schema_migrations.statements for version 20260701191239.
-- No live change is made by adding this file — it only brings the repo
-- mirror into sync with what is already running in production, so a
-- fresh `supabase db reset` from this repo reproduces live state.
-- 4) get_weekly_cpr_hours — active_team CTE
...
WITH
  ...
  active_team AS (
    ...
    WHERE agency_id = p_agency_id
      ...
      AND is_admin_backoffice = false  -- 2026-07-01: exclude admin_backoffice
