-- Change vote-pending indicator in team_checkin_send_reminder from bare count
-- ("🗳️ 3") to "🗳️ Vote Required" (singular) or "🗳️ Vote Required (N)" for
-- multiple. Signaling intent, not just count.
