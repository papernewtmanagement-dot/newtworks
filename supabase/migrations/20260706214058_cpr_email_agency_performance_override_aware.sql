...
BEGIN
  ...
  -- ====== FIX 2026-07-06 ======
  -- Removed `AND auto_new_ytd IS NOT NULL` from snapshot query so we can still
  -- render the section when overrides exist but snapshot columns are NULL.
  ...
  -- Render section if snapshot exists OR any manual override is set.
