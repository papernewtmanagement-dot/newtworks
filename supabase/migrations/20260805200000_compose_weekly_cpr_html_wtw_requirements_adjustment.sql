...
BEGIN
  ...
  -- Requirements adjustment (locked 2026-08-05). Drift-safe by design: reads the stored
  -- weekly_cpr_reports columns stamped by write_weekly_comp_v2, no recompute here. Condition-
  -- of-earning framing only — never "deduction"/"penalty"/"clawback"/"docked".
