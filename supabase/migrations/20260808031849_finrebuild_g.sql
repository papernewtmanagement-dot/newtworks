...
DECLARE
  ...
  v_jes jsonb := '[]'::jsonb;
BEGIN
  -- 2026-08-08: payroll_runs.journal_entry_id was dropped in the finrebuild (GL legs are now
  -- found by reference_number against public.ledger, not by a stored FK on payroll_runs).
