...
-- 2. reference_*: always return NULL (keep signatures; reference layer dormant until real data source exists)
...
-- 3. _hiregauge_lss_autopass: drop p_target_role param (signature change → drop old 8-arg)
...
-- 5. DROP VIEW + CREATE VIEW v_hiring_candidates (remove 11 cols; simplify assessment_nature call to no-arg)
