...
-- quarter_year, lead_sources, etc.). Stripping unknown fields before insert lets the
-- runner support recipes whose LLM response carries extra context fields that don't
-- belong on the primary table (e.g., book_snapshot recipe with lead_sources arrays).
