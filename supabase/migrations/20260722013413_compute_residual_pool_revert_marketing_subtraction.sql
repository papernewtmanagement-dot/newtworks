-- 2026-07-21: revert marketing bonus subtraction. Marketing bonus is funded from its
-- own budget line (marketing_pool basis, tracked via marketing_pool_earned_weekly) and
-- is NOT part of the residual pool. Restore compute to post-PTO state (migration 235000).
