...
-- This migration was applied live on 2026-07-22 00:42:48 UTC (ledger name: v_hiring_candidates_add_resume_avg_v2) but was never
-- committed to this repo at the time. Content below is copied verbatim
-- from supabase_migrations.schema_migrations.statements for version 20260722004248.
-- No live change is made by adding this file — it only brings the repo
-- mirror into sync with what is already running in production, so a
-- fresh `supabase db reset` from this repo reproduces live state.
-- CREATE OR REPLACE VIEW requires existing columns keep same ordering.
-- Add hc.resume_avg at the END of the projection.
...
-- Verify
SELECT candidate_name, resume_avg, assessment_composite
FROM public.v_hiring_candidates
WHERE agency_id='126794dd-25ff-47d2-a436-724499733365'
  AND resume_avg IS NOT NULL
ORDER BY resume_avg DESC LIMIT 5;
