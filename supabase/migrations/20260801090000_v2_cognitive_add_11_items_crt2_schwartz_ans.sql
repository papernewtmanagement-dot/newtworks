...
--
-- Sources:
-- 1) Thomson, K.S. & Oppenheimer, D.M. (2016). Investigating an alternate
--    form of the cognitive reflection test. Judgment and Decision Making,
--    11(1), 99-113. ("CRT-2" -- verbal/logic items, avoids the numeracy
--    confound of the original 3-item CRT already shipped.)
-- 2) Schwartz, L.M., Woloshin, S., Black, W.C., & Welch, H.G. (1997). The
--    role of numeracy in understanding the benefit of screening mammography.
--    Annals of Internal Medicine, 127(11), 966-972. (Text verified via
--    riskliteracy.org, the Berlin Numeracy Test authors' own site, which
--    republishes these as the standard numeracy-scale supplement.)
-- 3) Weller, J.A., Dieckmann, N.F., Tusler, M., Mertz, C.K., Burns, W.J., &
--    Peters, E. (2013). Development and testing of an abbreviated numeracy
--    scale: A Rasch analysis approach. Journal of Behavioral Decision
--    Making, 26(2), 198-212. ("ANS" -- includes a euro-denominated isomorph
--    of the classic bat-and-ball problem, distinct wording from the CRT
--    original already shipped.)
