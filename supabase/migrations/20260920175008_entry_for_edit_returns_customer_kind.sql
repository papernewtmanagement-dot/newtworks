-- The edit form needs to know whether the record is a person or an organization
-- so the toggle opens on the right setting.
...
BEGIN
  ...
  ELSIF v_kind = 'activity' THEN
    ...
    v_out := jsonb_build_object(
      ...
      'customer_kind', l.customer_kind,
      'phone_last4', l.phone_last4, 'date', l.occurred_on,
      'activity_key', l.activity_key, 'note', l.note, 'ecrm_url', l.ecrm_url,
      'save_line', l.save_line, 'review_platform', l.review_platform, 'save_reason', l.save_reason,
