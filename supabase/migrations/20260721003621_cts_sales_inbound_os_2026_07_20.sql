-- Replace placeholder cts_sales_inbound_os with aspirant-base + warm-inbound augmentation.
-- Design: no inbound-specific vendor score exists (Compare_Report_78313.xlsx has single OS column
-- used to fit outbound). Base = aspirant formula (neutral sales, R²=0.9988 vs vendor).
