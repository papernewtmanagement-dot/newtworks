...
DELETE FROM public.hiregauge_rules WHERE id = '4539625d-6d33-4df8-9908-c55b62e29e42';

ALTER TABLE public.hiring_candidates DROP COLUMN IF EXISTS response_distortion;
