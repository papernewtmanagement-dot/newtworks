-- needs_referral is NULL when the marketing source is NULL, which made
-- missing_count NULL and sank those rows to the bottom of the "most missing"
-- sort. Count an unknown as a no.
CREATE OR REPLACE FUNCTION public.rp_backfill_queue(
