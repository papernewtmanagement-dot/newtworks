-- Update render_cpr_section_11_html: remove the Prize Cart Budget + WtQ Trip Budget bottom table
...
BEGIN
  ...
  v_html := v_html
    ...
    || '</tr>'
    || '</tbody></table>'
    -- Prize Cart Budget + WtQ Trip Budget bottom table REMOVED 2026-06-20.
    -- Prize Cart Budget moves to the Prize Cart section header (not yet rendered in email);
    -- WtQ Trip Budget removed entirely.
    || '</div>';
