-- v2: include array index in reference so same-day identical-amount txns don't collide
...
BEGIN
  ...
  LOOP
    ...
    -- Reference now includes the ordinal so identical (date,payee,memo,amount) rows are distinct
