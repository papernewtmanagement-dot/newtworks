-- Peter directive 2026-07-23: layer-verdict + cell functions.
-- Character floor NOT a gate (principle rewritten same session).
-- Role arg on assessment + overall; NULL falls back to best-fit.
