...
-- Post-migration verification query (surface as a table)
SELECT 'journal_entries' AS tbl,
       (SELECT COUNT(*) FROM journal_entries WHERE business_entity_id='b1111111-1111-1111-1111-111111111111')::text AS still_on_papernewt,
       (SELECT COUNT(*) FROM journal_entries WHERE business_entity_id='b2222222-2222-2222-2222-222222222222')::text AS on_agency;
