...
4:215-232; Wilk & Sackett 1996 Pers Psych 49:937-967; Ganzach 1998 JAP
83:526-539 -- supports a modest RETENTION/attitude risk in low-complexity
roles from overqualification, not a general performance decrement applied
across all 7 roles. Brown, Wai & Chabris 2021 Perspectives on Psych Sci
16:1337-1359 (that helper's own newest citation) finds ability-outcome
relations monotonic-positive with no high-end downturn -- directly
contradicting a universal performance penalty. Coward & Sackett 1990 and
Arneson, Sackett & Beatty 2011 Psych Sci 22:1000-1006 (linear
ability-performance, no high-end drop) are the reason the performance-side
penalty and all-roles scope were removed rather than kept and narrowed.
Aspirant (agent-aspirant, professional-managerial complexity) was the
worst-fit case for the old universal penalty: in complex work, LOW
ability predicts voluntary turnover, not high (Maltarich et al. 2010's own
finding is specific to low-complexity jobs).
...
DROP FUNCTION IF EXISTS public.hiregauge_lss_ceiling_penalty_v2(numeric, numeric);
