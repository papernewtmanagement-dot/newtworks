...
-- This migration was applied live on 2026-07-22 22:10:12 UTC (ledger name: res_structured_qualification_columns) but was never
-- committed to this repo at the time. Content below is copied verbatim
-- from supabase_migrations.schema_migrations.statements for version 20260722221012.
...
COMMENT ON COLUMN public.hiring_candidates.res_licenses IS
  'Structured license holdings. Keys: pc,lh,ips,series_6,series_63,series_7,series_24 (all bool). notes free text.';
COMMENT ON COLUMN public.hiring_candidates.res_languages IS
  'spanish tier: bilingual/professional/conversational/none. other_languages array optional.';
COMMENT ON COLUMN public.hiring_candidates.res_education IS
  'highest_completed enum. institution/field/year_completed raw values only.';
COMMENT ON COLUMN public.hiring_candidates.res_prior_similar_role IS
  'highest_relevance enum insurance_direct..none. success_signals array of evidence.';
