...
SELECT gen_random_uuid(), agency_id, '6160', 'Employee Relations & Meals', account_type, 'b1111111-1111-1111-1111-111111111111', true
FROM public.chart_of_accounts WHERE account_code='6160' AND business_entity_id='b2222222-2222-2222-2222-222222222222'
LIMIT 1;
