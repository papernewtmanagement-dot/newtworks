-- Wrap write_weekly_comp_v2 to also chain the marketing bonus writer
-- Non-destructive: only appends a marketing_bonus_result to existing return payload
