-- Update reclassifier: pending placeholders are now on *Unclassified (per entity), not SUSP.
...
BEGIN
  ...
  LOOP
    ...
    -- Find the *Unclassified line on this JE (any entity)
    ...
    -- Find the OTHER (non-placeholder) line
