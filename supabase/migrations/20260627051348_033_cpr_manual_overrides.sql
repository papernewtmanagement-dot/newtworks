-- Manual override fields on weekly_cpr_reports for Agency Performance section.
-- Snapshot auto-fill remains primary; manual values win when set (NULL = use snapshot).
-- Solves the recurring partial-snapshot pain (e.g. 6/20 row where YTD inputs came in NULL).
