-- Migration: assessment_role_fit_retention_reception_v3_4_realism_tune
-- 2026-07-24
--
-- Closes gap identified in retention_reception weight vector: prior v3.3 carried
-- ZERO weight on handles_objections, retention_watchfulness, and cadence_compliance.
-- Reception is the front-line spotter for objections (billing disputes, rate
-- pushback, cancellation intent) and churn signal (life events, shopping-around
-- language). Zero weight on those was structurally wrong.
--
-- Changes (positives):
--   rapid_rapport_warm          0.21 -> 0.18
--   listens_discovers_needs     0.17 -> 0.15
--   composure_under_load        0.14 -> 0.12
--   routing_judgment            0.14 -> 0.11  (retention_watchfulness now covers part)
--   pivots_to_customer_need     0.12 -> 0.10
--   handles_objections           NEW -> 0.08
--   queue_throughput_discipline 0.09 -> 0.08
--   makes_decisions_quickly     0.09 -> 0.07  (handles_objections now covers part)
--   attention_to_detail         0.07 -> 0.06
--   retention_watchfulness       NEW -> 0.05
--   manages_time_effectively    0.05 (unchanged)
--   receives_coaching           0.05 (unchanged)
--   cadence_compliance           NEW -> 0.04
--   positively_influences_team  0.05 -> 0.04
--
-- Negatives unchanged. Positive sum 1.18, negative sum -0.18, net 1.00 (v6 invariant).
-- Model tag bumped to role_fit_v3_4_realism_tune_2026_07_24.
