...
-- 1. Correct Stephanie's snapshot for every week BEFORE the promotion:
-- she was HOURLY $18/hr (evidence: SurePayroll payroll_detail 2026-07-04 
-- shows REGULAR $628.92 / 34.94h = $18.00/hr). Promotion 2026-07-13 flipped 
-- her to SALARY $800/wk going forward.
...
-- 2. Rewire get_weekly_cpr_hours: prefer snapshot pay_type + work_location
-- for the displayed week. Falls back to live team when snapshot missing.
...
WITH
  ...
  -- Snapshot-first: prefer team_weekly_snapshot for pay_type + work_location
  -- so historical CPR hours reflect end-of-week state, not today's live team.
  active_team AS (
    SELECT
      et.team_id,
