...
--
-- Original filter (compensation semantics, hand-rolled 4× duplicated across the codebase):
...
-- LEFT JOIN team is only needed for hire_date (used in ORDER BY); get_expected_teammates
-- returns start_date + last_name so ordering shape unchanged.
