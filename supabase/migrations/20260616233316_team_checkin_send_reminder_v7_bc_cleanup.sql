...
BEGIN
  ...
  -- Morning movement reminder (separator stays — A not selected)
  IF v_checkin_type = 'morning' THEN
    v_text := v_text || E'\n\n━━━━━━━━━━━━━━━━━━━\n'
  ...
  -- C: tightened Friday wrapup block (no separators in this section, terser questions)
  IF v_checkin_type = 'eod' AND v_dow = 5 THEN
    v_text := v_text || E'\n\n📝 Weekly wrapup — drop your answers below:\n\n'
