-- Fix week_sp branch: was comparing raw QTD sales_points to weekly bests (always false-positive).
-- Now computes weekly delta = curr QTD - prior Sat QTD within same quarter (floor 0 at Q start).
