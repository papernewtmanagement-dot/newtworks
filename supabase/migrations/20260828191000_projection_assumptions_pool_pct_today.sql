-- Peter 2026-08-28: chart back on today's numbers. This drops the
-- forward-window keys from the assumptions block and calls the
-- single-argument inputs function. Curve points keep carrying commission
-- and base+commission for the three-line chart.
