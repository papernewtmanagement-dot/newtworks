...
BEGIN
  ...
  IF v_quotes_pass AND v_sp_pass THEN
    ...
    -- MVP callout — only shown on winning weeks with a recorded MVP
  ...
  -- All-Star & Trailblazer crossings for this week (independent of WtW result).
  -- 1 SP = $1 by design, so SP-based categories render as money; week_quotes renders as count.
