-- Tier-3 DRY (Q1): render_team_status_block now uses get_expected_teammates('work_checkin').
--
...
--
-- Body unchanged apart from both roster queries (the count + the WITH clause).
