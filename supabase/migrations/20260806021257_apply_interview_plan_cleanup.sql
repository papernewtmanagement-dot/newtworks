-- Cleanup pass: removes the redundant first grouping loop and unused
-- v_construct_label / v_focus_label locals from 20260806021244. This is the live body.
...
BEGIN
  ...
  -- internally in the order build_interview_plan already placed them (priority DESC within
  -- each of universal_core -> triggered -> stretch as they were appended).
