...
DECLARE
  ...
  v_account_id uuid; v_business_entity_id uuid;
...
BEGIN
  ...
  LOOP
    ...
    -- D4: resolve the register row's account
    SELECT a.id, a.business_entity_id INTO v_account_id, v_business_entity_id
    FROM accounts a
    ...
    IF NOT p_dry_run THEN
      INSERT INTO ledger (
        ...
        classification_status, suspense_reason
      ) VALUES (
