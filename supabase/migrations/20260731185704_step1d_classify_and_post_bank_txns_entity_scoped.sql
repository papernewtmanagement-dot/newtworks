-- Step 1d of pipeline repair (2026-07-31): rewrite classify_and_post_bank_txns
-- (used by external bank-reparse flow) to derive entity from source-account
-- and use entity-scoped unclassified as suspense.
