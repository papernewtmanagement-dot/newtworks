-- ============================================================
-- NEWTWORKS AUTO-BRIDGE GENERATOR
...
CREATE OR REPLACE FUNCTION newtworks_generate_bridges(
...
-- SELECT * FROM newtworks_generate_bridges('{"employees":"staff","agencies":"agency"}'::jsonb);
