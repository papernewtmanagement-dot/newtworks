-- Hand-spec fns preserved production behavior: cts_best_fit_role passed avg_speed
-- (SUM/3) as lss_speed. Use AVG for speed inside these 5 fns so their scores
-- match pre-migration production output. Accuracy stays as SUM (matches original).
