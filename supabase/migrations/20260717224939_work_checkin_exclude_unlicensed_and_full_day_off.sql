...
--
-- Scope: work_checkin purpose only. Health check-ins untouched (Peter to confirm).
-- Also switches three time-off functions from work_checkin (semantic mismatch) 
-- to time_off_participant (their intended purpose).
