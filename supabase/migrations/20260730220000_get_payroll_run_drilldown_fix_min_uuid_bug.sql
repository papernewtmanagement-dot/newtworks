...
-- since it shipped 2026-07-18 (pg_stat_user_functions showed 0 successful calls prior).
-- Post-Phase-4 all payroll JEs are single-entity so the previously-dormant MIN branch
-- now fires every call and throws "function min(uuid) does not exist".
