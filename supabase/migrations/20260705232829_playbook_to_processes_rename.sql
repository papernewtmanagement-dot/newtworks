...
-- 6. Backward-compat view so any code still holding onto "playbook" (edge functions,
--    the OLD Vercel deploy during the switchover window) keeps working.
--    security_invoker=true keeps RLS scoped to the caller, not the view owner.
