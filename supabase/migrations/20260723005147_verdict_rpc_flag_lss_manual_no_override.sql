...
DECLARE
  ...
  v_lss_autopass jsonb; v_lss_autopass_status text;
BEGIN
  ...
  v_lss_autopass := public._hiregauge_lss_autopass(
    v_lss_acc, v_ta.reliability, v_ta.analytical::numeric,
  ...
  verdict := CASE
    ...
    WHEN v_lss_autopass_status = 'decline_lss' THEN 'decline_lss'
