-- Same NULL->false fix as Fix 3, applied to get_pnl_history_own_only, which is
-- the sibling function PLSection actually reads (same bug class, caught during
-- round 1's frontend work). Same COALESCE change, nothing else touched.
