-- 2026-07-29: pair_eriosto_on_smvc_credit — stop writing to redundant
-- journal_entries.business_entity_id / journal_lines.business_entity_id.
-- Entity flows through the account_id in each line (both accounts referenced
-- are Eriosto-owned per chart_of_accounts). Dedup guard reworked to key off
-- the Eriosto AR account_id in journal_lines instead of je.business_entity_id.
