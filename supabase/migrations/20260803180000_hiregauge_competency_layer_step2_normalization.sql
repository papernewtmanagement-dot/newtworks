...
CREATE OR REPLACE FUNCTION public._newtworks_reasoning_score(p_candidate hiring_candidates)
 RETURNS numeric
 LANGUAGE sql
 IMMUTABLE
AS $function$
...
CREATE OR REPLACE FUNCTION public._newtworks_sjt_topic_score(p_candidate hiring_candidates, p_topic text)
 RETURNS numeric
 LANGUAGE sql
 IMMUTABLE
AS $function$
