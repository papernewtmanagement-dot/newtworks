...
DECLARE
  ...
  v_dist_sev    numeric;
BEGIN
  -- Step 1: Distortion dampening on social-desirable traits
  ...
  -- Step 3: LSS flags + per-competency deltas
  ...
  IF v_has_lss THEN
    ...
    v_adj_hr  := 0.0;  -- Handles Rejection immune to LSS (emotional resilience, not cognitive)
  END IF;

  -- Step 4: Validity factors
