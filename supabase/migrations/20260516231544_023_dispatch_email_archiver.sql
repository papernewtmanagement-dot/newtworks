...
-- Grant: run_internal_recipe (SECURITY DEFINER) executes this from the
-- automation-runner Edge Function context. No explicit grant needed because
-- this function is also SECURITY DEFINER and lives in public schema.
