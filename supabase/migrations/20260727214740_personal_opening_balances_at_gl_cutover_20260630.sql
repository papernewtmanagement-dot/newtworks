...
--
-- All values computed live from journal_lines through 2026-06-30.
-- Additive INSERT only. Zero UPDATE / DELETE.
...
VALUES
  -- Personal cash (assets — positive = cash on hand)
  ...
  -- Personal credit cards (liabilities — positive = amount owed)
