...
-- Then rename originals + their previously-reversed peers with -VOIDED-remap suffix so writer can repost cleanly.

-- Step 1: insert 9 reversal JEs (debits/credits flipped)
WITH originals AS (
