-- Wire audit_weekly_leaderboard_crossings into write_weekly_comp_v2 tail
-- Also replaces quarter_close's placeholder step 4 with a real call to the same audit fn
...
BEGIN
  ...
  -- NEW: leaderboard + trailblazer + all-star audit (wrapped for safety)
  BEGIN
