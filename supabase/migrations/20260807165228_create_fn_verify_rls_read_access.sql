...
-- This migration was applied live on 2026-08-07 16:52:28 UTC (ledger name: create_fn_verify_rls_read_access) but was never
-- committed to this repo at the time. Content below is copied verbatim
-- from supabase_migrations.schema_migrations.statements for version 20260807165228.
...
BEGIN
  FOREACH t IN ARRAY p_tables LOOP
    ...
    SELECT array_agg(DISTINCT grantee) INTO v_roles
    FROM information_schema.role_table_grants
    WHERE table_schema = 'public' AND table_name = t AND privilege_type = 'SELECT'
