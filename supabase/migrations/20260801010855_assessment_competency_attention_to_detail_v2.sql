...
-- (a) Seed attention_to_detail floor
...
-- (b) Rewrite fn body: v2 signal source + 2c curve, base + reliability adjustment unchanged
...
- Salthouse 1996 — processing speed as general cognitive factor; underpins verification accuracy
