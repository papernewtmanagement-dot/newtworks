...
INSERT INTO public.hiregauge_competency_floors (agency_id, competency_name, floor, notes, updated_by)
VALUES ('126794dd-25ff-47d2-a436-724499733365', 'handles_rejection', 35,
  $$Floor 35. Pure emotional resilience competency. Base weights optimism (0.33) + independent_spirit (0.21) heaviest; analytical NEGATIVE weight (-0.06). Bouncing back from rejection is temperament + emotional regulation, not cognition. Same tier as competes_for_recognition and dials_cold_calls. Citations: Barrick & Mount 1991, Judge & Ilies 2002, Scheier & Carver 1985 (dispositional optimism), Zhou/Kuncel/Sackett 2024, Kane 1996, Sweller 1988, Coward/Sackett 1990.$$,
  'claude_conversation')
ON CONFLICT (agency_id, competency_name) DO UPDATE
SET floor=EXCLUDED.floor, notes=EXCLUDED.notes, updated_at=now(), updated_by=EXCLUDED.updated_by;
...
INSERT INTO public.hiregauge_competency_floors (agency_id, competency_name, floor, notes, updated_by)
VALUES ('126794dd-25ff-47d2-a436-724499733365', 'has_entrepreneurial_spirit', 40,
  $$Floor 40. Personality-driven with modest self-management working-memory load. Base weights: independent_spirit (0.51) dominant, deadline_motivation (0.25), assertiveness (0.24). Entrepreneurial drive is temperament-based; below composite 40, self-directed planning + execution without close supervision may become patchy. Parity with cadence_compliance (40). Citations: Zhao & Seibert 2006, Rauch & Frese 2007, Barrick & Mount 1991, Hunter & Hunter 1984, Zhou/Kuncel/Sackett 2024, Kane 1996, Sweller 1988, Coward/Sackett 1990.$$,
  'claude_conversation')
ON CONFLICT (agency_id, competency_name) DO UPDATE
SET floor=EXCLUDED.floor, notes=EXCLUDED.notes, updated_at=now(), updated_by=EXCLUDED.updated_by;
