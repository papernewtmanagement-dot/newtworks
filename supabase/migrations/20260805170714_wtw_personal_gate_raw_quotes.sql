-- Win the Week personal day-off gate: RAW quotes, not net.
-- Peter directive 2026-08-05. Retroactive to the week ending 2026-08-01.
--
-- WHY: net quotes = quotes_discussed - quotes consumed paying off missed
-- checklist items. Gating an individual perk on that number meant (a) a
-- TEAM checklist miss nobody personally dropped could take an individual's
-- day off, and (b) anyone performing exactly to standard (15 sales /
-- 8 retention) flipped from pass to fail on a single quote of debt.
-- Missed requirements now cost money instead (see $10-per-quote-under
-- charge), not the day off. Team quote requirement is UNCHANGED and still
-- runs on net.
