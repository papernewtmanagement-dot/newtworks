...
-- subtraction. Currently base_by_week and actual_base_this_week sum only
-- SALARY + REGULAR + HOURLY. PTO is a separate line item in SurePayroll raw_earnings.
--
-- Confirmed reconciliation for week ending 07-18:
...
-- Everything else (commission joins, bonus joins, mgr joins, fallbacks, diag, freeze
-- guard) unchanged.
