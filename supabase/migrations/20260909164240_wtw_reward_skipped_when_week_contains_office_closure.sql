...
-- Wrapper: surface the new counter in the automation log summary.
...
BEGIN
  ...
  RETURN v_result || jsonb_build_object(
    ...
    'output_summary', format(
      'week %s-%s (prior Sat %s): won_prior_week=%s, created=%s, skipped(dup=%s trigger=%s personal_min=%s ineligible_role=%s office_closed=%s)%s',
