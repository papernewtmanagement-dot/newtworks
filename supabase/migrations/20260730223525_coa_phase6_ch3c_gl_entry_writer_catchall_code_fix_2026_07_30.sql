-- Phase 6 Chunk 3c — fix catchall lookups in gl_entry_writer
-- Legacy codes COA-UNCL-PSS-INC / COA-UNCL-PSS don't exist. Current active catchalls under Phase 4
-- numbering are 0002 *Unclassified Income (PSS) and 0003 *Unclassified Expense — Business (PSS).
-- Scope by PSS entity since comp routing is PSS-only.
