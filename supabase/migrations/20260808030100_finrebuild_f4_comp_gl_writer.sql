...
--
-- Recipe "GL Entry Writer" repointed to internal_handler='comp_gl_writer',
-- renamed "Comp GL Writer" (same automation_recipes row, id
-- 8ebc4378-592a-4814-9a8a-c672f3521ab3). Dry-run verified clean (0
-- eligible -- no unposted comp_recap rows currently).
...
SET internal_handler = 'comp_gl_writer', recipe_name = 'Comp GL Writer'
WHERE internal_handler = 'gl_entry_writer';
