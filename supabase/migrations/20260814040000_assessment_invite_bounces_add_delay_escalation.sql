...
-- A single delay stays informational (Gmail retry, not a real problem) -- this does
-- NOT reverse the 2026-08-13 rule that a single delay is not a bounce, it adds a
-- repeat-count escalation on top of it.
