...
-- when it was added to the authoritative list. Caught by F1 final sweep
-- check. Only one policy exists on this table - a regex-filtered read,
-- no separate write policy for authenticated at all.
