...
BEGIN
  ...
  -- Roster via canonical (agency_active_all, as_of=NULL → strict archived_at IS NULL)
...
-- (3) huddle_calendar_sync (1-arg): DROP first (has DEFAULT on p_agency_id),
--     then CREATE preserving the default.
