-- Peter directive 2026-07-29: revert get_pnl_history_own_only to original NULLIF
-- behavior. The display band-aid was the wrong instinct — direct-to-parent
-- bookings should be visible as bugs, not silently folded into their parent
-- section. Real fix is at the classifier + trigger level.
