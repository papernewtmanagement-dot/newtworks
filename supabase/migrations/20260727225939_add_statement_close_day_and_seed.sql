...
-- Seed known statement close days from ingest history
...
UPDATE public.bank_accounts SET statement_close_day = 31 WHERE account_number_last4 = '6596' AND agency_id='126794dd-25ff-47d2-a436-724499733365'; -- last day
UPDATE public.bank_accounts SET statement_close_day = 31 WHERE account_number_last4 = '3977' AND agency_id='126794dd-25ff-47d2-a436-724499733365'; -- last day
...
UPDATE public.credit_accounts SET statement_close_day = 15 WHERE account_number_last4 = '1006' AND agency_id='126794dd-25ff-47d2-a436-724499733365'; -- AMEX Personal, ~mid-month per prior anchor 2/15
UPDATE public.credit_accounts SET statement_close_day =  5 WHERE account_number_last4 = '1247' AND agency_id='126794dd-25ff-47d2-a436-724499733365'; -- CITI, anchor 12/4
-- Agency cards: closes align with US Bank Business CC cycle (SF Cards + Chase) — leave NULL for Peter to fill
