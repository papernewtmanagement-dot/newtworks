-- work_checkin roster: license no longer required (Peter 2026-09-14).
-- Every active agency teammate flagged into the check-ins has to react to the
-- reminder, whether or not they hold a license. This brings Cassie onto the
-- nag list and onto the daily commits block. work_display and every other
