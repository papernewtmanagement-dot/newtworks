-- Peter 2026-09-14: the midday message is the results template, and the results
-- template shows the done / not-done mark next to a commit. Restored. The only
-- thing that stays end-of-day-only is the wrap-up link.
...
BEGIN
  ...
  -- Both messages carry the commits with their done / not-done marks. Only the
  -- HTML flag differs, because only the EOD message is sent as HTML.
