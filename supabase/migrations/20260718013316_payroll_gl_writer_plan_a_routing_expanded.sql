...
BEGIN
  ...
  LOOP
    ...
    LOOP
      ...
      -- Plan A routing: PaperNewt direct if Owner OR admin_backoffice OR employee_entity=PaperNewt
      ...
      IF v_route_papernewt THEN
        -- PaperNewt direct path: whole gross + ER taxes to PaperNewt-side expense
