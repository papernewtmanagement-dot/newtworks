-- 1) Work compile: drop "fresh/carried/0-0" decomposition. New footer reads
--    "Team: Q/S  •  X of Y reporting"  where X = fresh count.
--    Per-person lines unchanged (still tag carried as "(carried from Jun 16 eod)").
...
BEGIN
  ...
  -- New footer: drop fresh/carried/0-0 decomposition; just "X of Y reporting"
  ...
  RETURN jsonb_build_object(
    ...
    'output_summary', format('%s compile: %s of %s reporting; totals %s/%s (runtime-only, not stored)',
