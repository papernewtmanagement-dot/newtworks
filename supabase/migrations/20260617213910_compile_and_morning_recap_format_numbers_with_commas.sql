-- Add thousands separators (commas) to all the numbers in the Win the Week
-- comparison block of both compile + morning recap. SP and quote counts
-- become readable when they grow into the thousands.
...
-- Same comma formatting for the morning recap path
