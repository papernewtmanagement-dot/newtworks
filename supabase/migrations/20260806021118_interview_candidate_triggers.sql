...
BEGIN
  ...
  -- ===== Resume-vs-assessment gap triggers: no commitment/character composite score
  -- column exists yet on hiring_candidates (verified live schema 2026-08-05: no
  -- iv_commitment, no character_* composite). Per handoff instruction, skip rather
  -- than fabricate -- not implemented until those columns exist.
