...
-- Rewrite v_balance_sheet_anchored to read business_entity_id from chart_of_accounts
-- instead of from journal_entries. Semantics identical to Thread B's P&L rewrite.
