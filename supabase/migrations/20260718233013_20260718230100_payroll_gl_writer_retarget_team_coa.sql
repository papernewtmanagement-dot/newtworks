-- payroll_gl_writer: swap v_team_acct lookup from retired COA-SUB-087 -> COA-SUB-078 "6005 Payroll Costs"
-- Only the account_code literal changes. Body untouched otherwise.
