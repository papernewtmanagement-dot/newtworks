...
COMMENT ON FUNCTION public.cts_retention_reception_competencies IS
  'HireGauge Step 5 v1: Retention-Reception competency vector. LDN + MDQ + RC + PIT + rapid_rapport_warm + routing_judgment + composure_under_load + pivots_to_customer_need (hand-spec).';
