...
-- ============================================================
-- HR data layer:
--   (1) staff_assessments    — CTS / LSS profile data
--   (2) staff_behavioral_notes — observations and patterns over time
--   (3) staff extensions      — performance status, role fit, fallback role
-- ============================================================
...
CREATE TABLE IF NOT EXISTS public.staff_assessments (
  ...
  -- Competencies (jsonb to handle varying assessment types)
