-- E: simplify the 7 PM health prompt
...
BEGIN
  ...
  -- v3: tightened to match work-checkin style
...
-- D-style trim on the health compile footer too (one line, no separator)
...
BEGIN
  ...
  -- D-style trim: one-line footer, no separator
