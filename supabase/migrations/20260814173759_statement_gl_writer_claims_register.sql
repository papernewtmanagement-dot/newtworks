  ...
  LOOP
    ...
    IF v_stmt_account_id IS NOT NULL THEN
      ...
      IF v_claim_direction IS NOT NULL THEN
        IF p_dry_run THEN
          SELECT l2.id, l2.classification_status, l2.account_id
          INTO v_claim_ledger_id, v_claim_old_status, v_claim_old_account_id
          FROM ledger l2
        ...
        ELSE
          ...
          RETURNING l.id, l.classification_status, l.account_id
          INTO v_claim_ledger_id, v_claim_old_status, v_claim_old_account_id;
          ...
          IF v_claim_ledger_id IS NOT NULL THEN
            ...
            SET coding_status = 'statement_confirmed',
                ...
                updated_at = NOW()
            WHERE cr.id = (SELECT cash_register_id FROM ledger WHERE id = v_claim_ledger_id);
          END IF;
        END IF;
      END IF;
    END IF;
