...
-- Two operations: INSERT missing anchors, UPDATE one stale.

-- (a) Agency-side missing anchors
...
-- (b) Stale anchor: Chase Marketing 2 was $3,923.55, ledger now sums to $8,409.59 through 6/30
