-- Sending the attendees array replaces it wholesale, which wipes everyone's
-- accepted/declined answer back to "needs action". Only send it when the guest
-- list actually changed. A time or title edit now leaves the guest list, and
-- everyone's answer, completely alone.
...
BEGIN
  ...
  ELSE
    ...
    ELSE
      ...
      -- list, because resending it wipes everyone's accepted/declined answer.
