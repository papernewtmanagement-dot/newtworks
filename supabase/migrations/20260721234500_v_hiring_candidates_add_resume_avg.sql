-- Add hc.resume_avg to v_hiring_candidates so PostgREST can select the generated column.
-- Column added at the end of projection because CREATE OR REPLACE VIEW requires existing
-- column ordering to be preserved.
