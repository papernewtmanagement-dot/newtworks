-- =========================================================================
-- Migration: step1f_reclassify_pending_je_entity_scoped
-- Applied: 2026-07-31 via Supabase MCP (session: pipeline_repair_step1)
-- =========================================================================
-- Rewrite reclassify_pending_je: placeholder-line lookup matches real
-- entity-scoped unclassified names ('*Unclassified Income',
-- '*Unclassified Expense — Business', etc.). Target account lookup prefers
-- same-entity copies.
-- =========================================================================

-- Fix: placeholder lookup uses account_name LIKE '*Unclassified%' (real names
-- are entity-suffixed) and prefer same-entity target account lookup.
...
BEGIN
  ...
  LOOP
    ...
    -- Find the placeholder line — match any entity-scoped unclassified/suspense account
    ...
    -- Find the OTHER line and its entity
    ...
    -- Same-entity lookup preferred, any-entity fallback
