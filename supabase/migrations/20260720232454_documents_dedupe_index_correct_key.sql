-- Correction of the earlier migration: dedupe key is (gmail_message_id, file_name),
-- not (gmail_message_id, gmail_attachment_id). Attachment IDs rotate per Gmail API
-- call, verified 2026-07-20 (same attachment returned different IDs on two calls).
...
-- gmail_attachment_id column kept as debug/aux; code still writes it. Column
